...
public Connection getConnection()  {
    ...
    //   	connexion = ds.getConnection(); commentaire le 04/12/2020 herou java.lang.NullPointerException voire line 49
		   ...
		   Class.forName("com.mysql.cj.jdbc.Driver");
		    String url = "jdbc:mysql://mysql-acosparla.alwaysdata.net:3306/acosparla_tennis?useSSL=false&useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC"; 
